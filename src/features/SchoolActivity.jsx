  ...
  return (
    <div>
      <div className="section-header">
        ...
        <p>Practical, shareable guidance for the real situations families with type 1 diabetes face every day — school, sport, and social life.</p>
      </div>
