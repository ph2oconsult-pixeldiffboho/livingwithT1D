...
const patterns = [
  ...
  },
  {
    ...
    searchTerms: ["exercise raises blood sugar", "sport glucose spike", "adrenaline diabetes"],
    tldr: "High-intensity exercise releases adrenaline, which triggers the liver to dump glucose — temporarily raising blood sugar.",
    ...
    whyItHappens: `Exercise affects glucose in two fundamentally different ways depending on intensity:\n\n**Aerobic exercise** (steady jogging, swimming laps, cycling at moderate pace): Muscles absorb glucose directly without insulin. Glucose typically falls during and after activity.\n\n**Anaerobic / high-intensity exercise** (sprinting, competitive races, intense interval training, heavy weightlifting): The body perceives this as a "fight or flight" stress. It releases adrenaline and cortisol. These hormones signal the liver to release stored glucose (glycogen) into the bloodstream — providing emergency fuel.\n\nIn a person without T1D, the pancreas instantly releases insulin to balance this glucose dump. In T1D, no such automatic response occurs. The result is a temporary glucose rise that can be significant — sometimes 3–5 mmol/L — during or shortly after intense activity.\n\nMost team sports like soccer and basketball involve both types: long aerobic periods interrupted by short explosive sprints. Glucose may fall during play then spike at the final whistle.`,
    ...
    shareableInsight: "Sprinting releases adrenaline, which tells the liver to dump glucose. That's why intense sport can raise blood sugar instead of lowering it.",
  },
  {
    id: "overnight-rise",
    number: "03",
    ...
    whyItHappens: `The human body releases growth hormone in pulses during deep sleep. This is a normal and essential part of childhood development.\n\nGrowth hormone is an insulin antagonist — it directly reduces insulin's effectiveness. During growth hormone pulses, the same amount of insulin has less effect than it would during the day.\n\nAdditionally, cortisol (the "waking up" hormone) rises in the early morning hours (typically 4–8am) to prepare the body for the day. Cortisol also increases insulin resistance.\n\nIn people without T1D, the pancreas automatically produces more insulin to compensate for these hormonal effects. In T1D, the basal insulin dose was set for average conditions — it cannot automatically increase when growth hormone surges.\n\nThis phenomenon is called the **Dawn Phenomenon** and is extremely common in children and adolescents with T1D — precisely because they release more growth hormone than adults.\n\nA related pattern, the **Somogyi Effect**, occurs when a glucose drop overnight triggers a hormonal rebound that pushes glucose high by morning. CGM data can distinguish between the two.`,
    practical: `• The dawn phenomenon is not a management failure — it is a predictable hormonal pattern\n• Review overnight CGM data with your diabetes team — adjusting basal insulin timing or dose often helps\n• For pump users: a higher temporary basal rate in the early morning hours is a common strategy\n• For MDI users: injection timing adjustments or changing to a different basal insulin may help\n• Do not chase overnight highs with correction doses without understanding the pattern first`,
  ...
  },
  {
    ...
    tldr: "Muscles continue absorbing glucose for up to 12 hours after exercise to replenish glycogen stores — creating an extended overnight hypoglycaemia risk.",
