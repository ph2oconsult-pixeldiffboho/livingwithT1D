  ...
  return (
    <div>
      <div className="section-header">
        ...
        <p>Simulate common type 1 diabetes situations before they happen. Build confidence by understanding likely glucose responses in advance.</p>
      </div>
